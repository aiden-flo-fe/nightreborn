...
function createIconInstructions() {
  ...
  console.log('- 저장 위치: build/icons/icon.icns');

  console.log('\n🪟 Windows용 (.ico):');
  console.log('- 온라인 변환: https://cloudconvert.com/png-to-ico');
  console.log('- 저장 위치: build/icons/icon.ico');

  console.log('\n🐧 Linux용 (.png):');
  console.log('- 원본 파일을 복사하거나 512x512로 리사이즈');
  console.log('- 저장 위치: build/icons/icon.png');
  ...
  console.log('iconutil -c icns icon.iconset -o build/icons/icon.icns');
